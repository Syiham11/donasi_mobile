...
import 'package:donasi_mobile/widgets/notification_text.dart';
...
class AuthProvider with ChangeNotifier {
  ...
  // final String api = 'https://beespokewoodcraft.co.uk/api/v1/auth';
    final String api = 'https://bo.amalku.net/api/v1';
  ...
  Future<Map> register(String name, String regTipe, String referal, String email, String password, String passwordConfirm) async {
    ...
    if (response.statusCode == 422) {
       if (apiResponse['errors'].containsKey('referal')) {
        result['message'] = apiResponse['errors']['referal'][0];
        return result;
      }
      if (apiResponse['errors'].containsKey('regTipe')) {
        result['message'] = apiResponse['errors']['regTipe'][0];
        return result;
      }
